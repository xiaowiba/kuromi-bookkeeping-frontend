...
const list = [
  ...
  {
    alias: 'Kuromi Bookkeeping Frontend',
    name: 'kuromi-bookkeeping-frontend',
    owner: 'xiaowiba',
    desc: '全新 3.x 版本，基于 Gi Demo 前端模板开发的 ContiNew Admin 前端适配项目。',
    logo: 'https://continew.top/logo.svg',
    url: 'https://github.com/xiaowiba/kuromi-bookkeeping-frontend/stargazers',
    status: '迭代',
    statusColor: 'rgb(var(--primary-6))',
  },
  {
    alias: 'ContiNew Admin UI Arco',
    name: 'arco-legacy-demo',
    owner: 'continew-org',
